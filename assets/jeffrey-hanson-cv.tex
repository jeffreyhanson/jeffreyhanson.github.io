...
\item[2022] Marques AJD, \textbf{Hanson JO}, Camacho-Sanchez M, Martínez‐Solano Í, Moritz C, Tarroso P, Velo‐Antón G, Veríssimo A \& Carvalho SB (2022) Range-wide genomic scans and tests for selection identify non-neutral spatial patterns of genetic variation in a non-model amphibian species (\textit{Pelobates cultripes}). \textit{Conservation Genetics}, In press: DOI:10.1007/s10592-021-01425-3.
